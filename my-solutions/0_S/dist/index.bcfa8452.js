...
let car = new (0, _car.Car)(100);
const arrCarStatusMessages = {
    "radio": {
        turnOn: "Turn music on",
        turnOff: "Turn music off"
    },
    "engine": {
        turnOn: "Turn engine on",
        turnOff: "Turn engine off"
    }
};
musicToggleElement.addEventListener("click", ()=>{
    if (car.musicPlayer.volume === 0) {
        ...
        musicToggleElement.innerText = arrCarStatusMessages["radio"].turnOff;
        return;
    }
    musicToggleElement.innerText = arrCarStatusMessages["radio"].turnOn;
...
musicSliderElement.addEventListener("input", (event)=>{
    ...
    musicToggleElement.innerText = car.musicPlayer.volume ? arrCarStatusMessages["radio"].turnOn : arrCarStatusMessages["radio"].turnOff;
});
engineToggleElement.addEventListener("click", ()=>{
    if (car.engine.status) {
        car.engine.turnOff();
        engineToggleElement.innerText = arrCarStatusMessages["engine"].turnOn;
        return;
    }
    engineToggleElement.innerText = arrCarStatusMessages["engine"].turnOff;
    car.engine.turnOn();
});
addFuelForm.addEventListener("submit", (event)=>{
    event.preventDefault();
    car.fueltank.addFuel(Number(addFuelInput.value));
    fuelLevelElement.innerText = car.fueltank.amountOfFuel.toString();
});
setInterval(()=>{
    car.drive();
    //while it looks like both lines below are the same there is a subtle difference (you could put breakpoints here to see the difference):
    // this <cast> will only tell TypeScript that the value is a string, but the actual variable in JS is not changed in any way: it is in reality still a number
    milesElement.innerText = car.odoMeter.count;
    // This .toString() will actually convert the value in JavaScript from an integer to a string
    fuelLevelElement.innerText = car.fueltank.amountOfFuel.toString();
    if (car.musicPlayer.volume === 0) audioElement.pause();
    else audioElement.play();
}, 1000);

},{"./Models/Car":"6hwBi"}],"6hwBi":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Car", ()=>Car);
var _engine = require("./Engine");
var _engineDefault = parcelHelpers.interopDefault(_engine);
var _fuelTank = require("./FuelTank");
var _fuelTankDefault = parcelHelpers.interopDefault(_fuelTank);
...
var _odometerDefault = parcelHelpers.interopDefault(_odometer);
class Car {
    constructor(MAXIMUM_FUEL_TANK_CAPACITY){
        this.MILES_PER_FUEL = 10;
        this.init(MAXIMUM_FUEL_TANK_CAPACITY);
    }
    init(MAXIMUM_FUEL_TANK_CAPACITY) {
        this._engine = new (0, _engineDefault.default)();
        this._fuelTank = new (0, _fuelTankDefault.default)(MAXIMUM_FUEL_TANK_CAPACITY);
        this._musicPlayer = new (0, _musicPlayerDefault.default)();
        this._odoMeter = new (0, _odometerDefault.default)();
    }
    get engine() {
        return this._engine;
    }
...
},{"./Engine":"bBa95","./FuelTank":"5xgx9","./MusicPlayer":"9L83x","./Odometer":"j3JvH","@parcel/transformer-js/src/esmodule-helpers.js":"aRELh"}],"bBa95":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Engine {
    constructor(){
...
},{}],"5xgx9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class FuelTank {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"aRELh"}],"9L83x":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class MusicPlayer {
    _volume = 0;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"aRELh"}],"j3JvH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Odometer {
    constructor(){
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"aRELh"}]},["bkwbw","7ZSs6"], "7ZSs6", "parcelRequire94c2")
